    ...
    towns.forEach(
        town => {
            if (town.name === 'Fish Haven') {
                ...
                document.querySelector('#prestonAnnualRainfall').textContent = `Annaul Rainfall: ${town.averageRainfall}`;
                ...
                document.querySelector('#sodaSpringsAnnualRainfall').textContent = `Annaul Rainfall: ${town.averageRainfall}`;
